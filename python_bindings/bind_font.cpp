...
void bind_font(py::module &a) {
    ...
    pyenum34<ace::draw::Align>(m, "Align")
    ...
    py::class_<Font>(m, "Font")
        .def("measure", &Font::measure, py::call_guard<py::gil_scoped_release>())
        .def("draw", py::overload_cast<const std::string &, glm::vec2, glm::vec3, glm::vec2, Align>(&Font::draw),
             "text"_a, "pos"_a, "color"_a = glm::vec3(1.0f), "scale"_a = glm::vec2(1.f), "align"_a = Align::BOTTOM_LEFT, py::call_guard<py::gil_scoped_release>())
        ...
        .def("get_aligned_position", &Font::get_aligned_position, py::call_guard<py::gil_scoped_release>());

    py::class_<Text>(m, "Label")
        .def(py::init<Font *, std::string, glm::vec3, glm::vec2, Align>(),
             "font"_a, "text"_a, "color"_a = glm::vec3(1.0f), "scale"_a = glm::vec2(1.f), "align"_a = Align::BOTTOM_LEFT, py::call_guard<py::gil_scoped_release>())
        .def("update", py::overload_cast<std::string, glm::vec3, glm::vec2, Align>(&Text::update),
             "text"_a, "color"_a = glm::vec3(1.0f), "scale"_a = glm::vec2(1.f), "align"_a = Align::BOTTOM_LEFT, py::call_guard<py::gil_scoped_release>())
        ...
        .def_property("text", &Text::str, &Text::set_str, py::call_guard<py::gil_scoped_release>())
